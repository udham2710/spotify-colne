        ...
        return (G = g(function* () {
            ...
            D.hasBasePath(o) && (o = k.removeBasePath(o));
          {
            let { normalizeLocalePath: t } = r(4769),
              { detectDomainLocale: u } = r(2388),
              { parseRelativeUrl: c } = r(2864),
              { formatUrl: d } = r(7795);
            if (a.locales) {
              let f = c(o),
                p = t(f.pathname, a.locales);
              p.detectedLocale
                ? ((f.pathname = p.pathname), (o = d(f)))
                : (h = a.locale);
          ...
          l
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                ea(y({}, e, { err: i, Component: s, styleSheets: u, props: t }))
              );
            })
        );
      }
          ...
          !(function (e, t) {
            ...
            if (J) {
              ...
              (J = P.default.hydrateRoot(e, r, {
                ...
                (Q = !1);
          })(i, (e) => _.default.createElement(en, { callbacks: [e, h] }, m)),
          p
        );
      }
      function eo(e) {
    ...
    532: function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.isInAmpMode = function () {
          let { ampFirst: e = !1, hybrid: t = !1, hasQuery: r = !1 } =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return e || (t && r);
        });
    },
      ...
      class Q {
          ...
          return n(function* () {
            ...
            let Z = 1 === o._h,
              z =
                ...
                w.parsePath(t).pathname === w.parsePath(r).pathname,
              V = a({}, i.state),
              X = !0 !== i.isReady;
            i.isReady = !0;
            let Y = i.isSsr;
            ...
            {
              (V.locale =
                !1 === o.locale ? i.defaultLocale : o.locale || V.locale),
                void 0 === o.locale && (o.locale = V.locale);
              let J = y.parseRelativeUrl(
                  O.hasBasePath(r) ? C.removeBasePath(r) : r
                ),
              ...
              ee.detectedLocale &&
                ...
                (t = j.addBasePath(
                  p.normalizeLocalePath(
                    O.hasBasePath(t) ? C.removeBasePath(t) : t,
                    i.locales
                  ).pathname
                )));
              let et = !1;
              (null == (n = i.locales) ? void 0 : n.includes(V.locale)) ||
                ((J.pathname = E.addLocale(J.pathname, V.locale)),
                K({ url: b.formatWithValidation(J), router: i }),
                (et = !0));
              ...
              if (
                ...
                er &&
                i.isLocaleDomain &&
                self.location.hostname !== er.domain
              ) {
            ...
            i._inFlightRoute &&
              i.clc &&
              (Y ||
                Q.events.emit("routeChangeError", I(), i._inFlightRoute, el),
              i.clc(),
              (i.clc = null)),
              (r = j.addBasePath(
                E.addLocale(
            ...
            if (!Z && i.onlyAHashChange(ei) && !es) {
              (V.asPath = ei),
                ...
                i.changeState(e, t, r, a({}, o, { scroll: !1 })),
              ...
              try {
                ...
                throw (
                  (d.default(eu) &&
                    eu.cancelled &&
                    Q.events.emit("routeChangeError", eu, ei, el),
                  eu)
                );
              }
            ...
            try {
              [D, { __rewrites: F }] = yield Promise.all([
            ...
            let em = s.removeTrailingSlash(ed),
              ...
              ey = !!(
                ...
                em !== eg &&
                (!g.isDynamicRoute(em) ||
                  !_.getRouteMatcher(P.getRouteRegex(em))(eg))
              ),
              ev =
                !o.shallow &&
                (yield N({ asPath: r, locale: V.locale, router: i }));
            if (
              (Z && ev && (z = !1),
              z &&
                "/_error" !== ed &&
            ...
            if (g.isDynamicRoute(em)) {
              ...
              if (e_ && (!ew || eE.result))
                ...
                let ex = Object.keys(eS.groups).filter(
                  (e) => !ef[e] && !eS.groups[e].optional
                );
                if (ex.length > 0 && !ev)
                  throw Error(
                    (ew
            ...
            try {
              ...
              if ("route" in eC && ev) {
                ...
                let ej = O.hasBasePath(ec.pathname)
                  ? C.removeBasePath(ec.pathname)
                  : ec.pathname;
                if (
                  (e_ &&
                    ed !== ej &&
                    Object.keys(e_).forEach((e) => {
                      e_ && ef[e] === e_[e] && delete ef[e];
                    }),
                  g.isDynamicRoute(ed))
                ) {
                  let eO =
                      !el.shallow && eC.resolvedAs
                        ? eC.resolvedAs
                        : j.addBasePath(
                            E.addLocale(
                  ...
                  O.hasBasePath(eR) && (eR = C.removeBasePath(eR));
                  {
                    ...
                    (V.locale = eL.detectedLocale || V.locale),
                      (eR = eL.pathname);
                  }
                  let eM = P.getRouteRegex(ed),
                    eA = _.getRouteMatcher(eM)(
                      new URL(eR, location.href).pathname
                    );
              ...
              if ("type" in eC) {
                ...
                return (
                  K({ url: eC.destination, router: i }), new Promise(() => {})
                );
              }
              let eT = eC.Component;
              ...
              if ((eC.__N_SSG || eC.__N_SSP) && eC.props) {
                if (eC.props.pageProps && eC.props.pageProps.__N_REDIRECT) {
                  ...
                  if (
                    eN.startsWith("/") &&
                    !1 !== eC.props.pageProps.__N_REDIRECT_BASE_PATH
                  ) {
                ...
                if (
                  ((V.isPreview = !!eC.props.__N_PREVIEW),
                  eC.props.notFound === G)
                ) {
                  let eU;
                  try {
              ...
              Z &&
                ...
                (null == (f = self.__NEXT_DATA__.props)
                  ...
                  ? void 0
                  : h.statusCode) === 500 &&
                (null == (v = eC.props) ? void 0 : v.pageProps) &&
                (eC.props.pageProps.statusCode = 500);
              let eF =
                  o.shallow && V.route === (null != (R = eC.route) ? R : em),
                eW = null != (L = o.scroll) ? L : !Z && !eF,
                eq = null != l ? l : eW ? { x: 0, y: 0 } : null,
                eZ = a({}, V, {
                  route: em,
                  pathname: ed,
                  query: ef,
              ...
              if (Z && ("/404" === i.pathname || "/_error" === i.pathname)) {
                ...
                "/_error" === i.pathname &&
                  (null == (M = self.__NEXT_DATA__.props)
                    ...
                    ? void 0
                    : T.statusCode) === 500 &&
                  (null == (k = eC.props) ? void 0 : k.pageProps) &&
                  (eC.props.pageProps.statusCode = 500);
                try {
                  ...
                  throw (
                    (d.default(ez) &&
                      ez.cancelled &&
                      Q.events.emit("routeChangeError", ez, ei, el),
                    ez)
                  );
                }
                return !0;
              ...
              let eG =
                Z && !eq && !X && !es && A.compareRouterStates(eZ, i.state);
              if (!eG) {
                try {
                  yield i.set(eZ, eC, eq);
                } catch (eV) {
                ...
                if (eC.error)
                  throw (
                    (Z || Q.events.emit("routeChangeError", eC.error, ei, el),
                    eC.error)
                  );
        ...
        handleRouteInfoError(e, t, r, a, o, l) {
          ...
          return n(function* () {
            ...
            try {
              let n;
              let { page: s, styleSheets: c } = yield i.fetchComponent(
                  "/_error"
                ),
                f = {
                  props: n,
            ...
            try {
              ...
              if (
                ...
                if (
                  ...
                  (o = a({}, o, L.effect.parsedAs.query)),
                  (i = C.removeBasePath(
                    p.normalizeLocalePath(L.effect.parsedAs.pathname, v.locales)
                      .pathname
                  )),
                  (x = v.components[e]),
              ...
              if (R.isAPIRoute(e))
                return K({ url: l, router: v }), new Promise(() => {});
              let T =
                  j ||
                  (yield v
                    .fetchComponent(e)
              ...
              I &&
                ...
                delete v.sdc[L.dataHref];
              let { props: k, cacheKey: D } = yield v._getData(
                n(function* () {
                  if (N) {
                    if ((null == L ? void 0 : L.json) && !I)
                      return { cacheKey: L.cacheKey, props: L.json };
                    let e = (null == L ? void 0 : L.dataHref)
                        ? L.dataHref
              ...
              return (
                T.__N_SSP && O.dataHref && D && delete v.sdc[D],
                v.isPreview ||
                  !T.__N_SSG ||
                  g ||
                  Y(
        ...
        prefetch(e) {
          ...
          return n(function* () {
              ...
              fetchData: () =>
                Y({
                  dataHref: o.pageLoader.getDataHref({
                    href: b.formatWithValidation({ pathname: u, query: i }),
                    skipInterpolation: !0,
                    asPath: h,
                    locale: m,
                  }),
            ...
            yield Promise.all([
              ...
              o.pageLoader[r.priority ? "loadPage" : "prefetch"](E),
            ]);
          })();
        }
        fetchComponent(e) {
        ...
        constructor(
          ...
          if (
            ...
            (this.isLocaleDomain = !!S.detectDomainLocale(
              v,
    ...
    8756: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.getNextPathnameInfo = function (e, t) {
          var r;
          let { basePath: l, i18n: i, trailingSlash: s } =
              null != (r = t.nextConfig) ? r : {},
            u = { pathname: e, trailingSlash: "/" !== e ? e.endsWith("/") : s };
          if (
            (l &&
              o.pathHasPrefix(u.pathname, l) &&
              ((u.pathname = a.removePathPrefix(u.pathname, l)),
              (u.basePath = l)),
            !0 === t.parseData &&
